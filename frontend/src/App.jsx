  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/online-education" element={<ProtectedRoute><MainLayout><PlaceholderPage title="Online ta'lim" /></MainLayout></ProtectedRoute>} />
        <Route path="/tests" element={<ProtectedRoute><MainLayout><Tests /></MainLayout></ProtectedRoute>} />
        <Route path="/navigator" element={<ProtectedRoute><MainLayout><PlaceholderPage title="Navigator (Edu-Map/Roadmaps)" /></MainLayout></ProtectedRoute>} />
        <Route path="/rating" element={<ProtectedRoute><MainLayout><PlaceholderPage title="Reyting (Leaderboard)" /></MainLayout></ProtectedRoute>} />
        <Route path="/library" element={<ProtectedRoute><MainLayout><PlaceholderPage title="Kutubxona" /></MainLayout></ProtectedRoute>} />
